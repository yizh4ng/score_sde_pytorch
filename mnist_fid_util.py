...
from mnist_inception import InceptionV3
...
def evaluate_fid_score(images1, images2, dim=64, batch_size=50):
    """Calculation of FID.
    Params:
    ...
    m1, s1 = calculate_activation_statistics(images1, model, batch_size, dim, device)
    m2, s2 = calculate_activation_statistics(images2, model, batch_size, dim, device)
